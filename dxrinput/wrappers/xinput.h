...
public:
	...
	__inline short LeftStick_Xs() { return LStick_InDeadzone() ? 0 : state.Gamepad.sThumbLX; }
	__inline short LeftStick_Ys() { return LStick_InDeadzone() ? 0 : state.Gamepad.sThumbLY; }
	float RightStick_X();    // Return X axis of right stick
	float RightStick_Y();    // Return Y axis of right stick
	__inline short RightStick_Xs() { return RStick_InDeadzone() ? 0 : state.Gamepad.sThumbRX; }
	__inline short RightStick_Ys() { return RStick_InDeadzone() ? 0 : state.Gamepad.sThumbRY; }
